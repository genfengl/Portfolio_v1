                    ...
                    xs:p-10 2xl:px-20">
                        ...
                        2xl:text-4xl ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                            ...
                            <div className='grid grid-cols-2 grid-rows-3 gap-3 text-xl mb-3'>
                                ...
                                {/* Express.js */}
                                <div className={`flex items-center gap-3 transition-all-all duration-1000 delay-500 ease-in-out
                                ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                                ...
                                {/* Firebase */}
                                <div className={`flex items-center gap-3 text-xl transition-all duration-1000 delay-1500 ease-in-out
                                ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                    ...
                    xs:p-10 2xl:px-20">
                        ...
                        2xl:text-4xl ${learningTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                            ...
                            <div className='grid grid-cols-2 grid-rows-3 gap-3 text-xl mb-3'>
                                ...
                                {/* Next.js */}
                                <div className={`flex items-center gap-3 transition-all-all duration-1000 delay-1000 ease-in-out
                                ${learningTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>

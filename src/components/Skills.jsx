...
const Skills = () => {
    ...
    const { ref: frontendTitleRef, inView: frontendTitleIsVisible } = useInView()
    const { ref: softwareDevTitleRef, inView: softwareDevTitleIsVisible } = useInView()
    const { ref: learningTitleRef, inView: learningTitleIsVisible } = useInView()
            ...
            <div className="container mx-auto flex flex-col py-16 px-3 mt-16 gap-6 dark:text-word">
                ...
                2xl:grid-cols-[450px_450px_450px]">
                    ...
                    xs:p-10 2xl:px-16">
                        ...
                        2xl:text-4xl ${softwareDevTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                            ...
                            <div className='grid grid-cols-2 grid-rows-3 gap-3 text-xl mb-3'>
                                {/* Javascript */}
                                <div className={`flex items-center gap-3 transition-all duration-1000 delay-300 ease-in-out
                                ...
                                {/* Typescript */}
                                <div className={`flex items-center gap-3 transition-all duration-1000 delay-600 ease-in-out
                                ${softwareDevTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'} `}>
                    ...
                    xs:p-10 2xl:px-16">
                            ...
                            transition-all duration-1000 ease-in-out
                        2xl:text-4xl ${frontendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                                <div>
                    ...
                    xs:p-10 2xl:px-16">
                            ...
                            transition-all duration-1000 ease-in-out
                        2xl:text-4xl ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                            ...
                            <div className='grid grid-cols-2 grid-rows-3 gap-3 text-xl mb-3'>
                                ...
                                transition-all duration-1000 delay-600 ease-in-out
                                ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                                ...
                                transition-all duration-1000 delay-900 ease-in-out
                                ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                                    <SiMongodb className='text-3xl text-green-500 dark:text-green-600' />
                                    MongoDB
                                </div>
                                {/* Firebase */}
                                <div className={`flex items-center gap-3 text-xl transition-all duration-1000 delay-900 ease-in-out
                                ${backendTitleIsVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>

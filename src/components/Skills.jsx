...
import {
    ...
    SiTypescript, SiMaterialui, SiKotlin
} from 'react-icons/si';
            ...
            <div className="container mx-auto flex flex-col px-3 py-16 gap-6">
                ...
                2xl:grid-cols-[498px_498px_498px]">
                    ...
                    <div className='relative shadow-xl rounded-xl'>
                        <div className='absolute w-full aspect-square bg-[url(/background1.jpg)] bg-cover rounded-xl z-[-10]'></div>
                        <div className="flex justify-center flex-col gap-6 p-6 rounded-xl w-full aspect-square
                    backdrop-blur-2xl bg-opacity-60 bg-violet-300 text-word
                    xs:p-10 2xl:px-20">
                            {/* Software Dev Title */}
                    ...
                    xs:p-10 2xl:px-20">
                        ...
                        2xl:text-4xl'>
                            ...
                            <div className='grid grid-cols-2 grid-rows-2 gap-3 text-xl mb-3'>
                                ...
                                {/* PostgreSQL */}
                                <div className='flex items-center gap-3 text-[14px] sm:text-xl'>
                    ...
                    ">
                            ...
                            <div className='text-3xl font-bold flex items-center justify-center gap-5 '>
                                ...
                                <div>
                                    <div className='mt-0.5 bg-red-400 h-2 w-[8.3rem] translate-y-8 
                                sm:max-md:translate-y-9 sm:max-md:w-[22rem]'></div>
                            ...
                            <div className='grid grid-cols-2 grid-rows-2 gap-3 text-xl mb-3'>
                                {/* Kotlin */}
                                <div className='flex items-center gap-3 text-xl'>
                                    <SiKotlin className='text-3xl text-amber-300' />
                                    Kotlin
                                </div>
                            </div>
